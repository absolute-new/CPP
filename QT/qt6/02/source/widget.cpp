...
Widget::Widget(QWidget* parent) : QWidget(parent)
{
    ...
    connect(btn3, &QPushButton::clicked, this, &Widget::on_btn3_clicked);
    connect(btn4, &QPushButton::clicked, this, &Widget::on_btn4_clicked);
}
...
{
    disconnect(btn1, &QPushButton::clicked, this, &Widget::on_btn1_clicked);
    btn2->setEnabled(false);
    btn3->setEnabled(false);
